...
public class JwtUtil {
    ...
    // Em um projeto real para colocar em produção, a chave secreta deve ficar no yml ou properties
    ...
    public Claims extractClaims(String token) {
        return Jwts.parser()
                ...
                .getPayload(); // Obtém o payload (corpo) do token, que cotém as claims
    }
